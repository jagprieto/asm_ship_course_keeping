...
if PARAMETERS.SIMULATION_TYPE  == 1
    ...
    PARAMETERS.initial_state = [10.0*pi/180.0, 0.0]; % yaw, r           
end
...
function SIMULATION_DATA = run_simulation(PARAMETERS)
    ...
    SIMULATION_DATA.NICB.control = 0.0;
    ...
    SIMULATION_DATA.AISM.int_dot_aism_alfa = PARAMETERS.CONTROL_ALFA_ZERO;
...
%         aism_kappa = ((PARAMETERS.KAPPA_GAIN^(aism_power_gain+1))*2.0)/aism_alfa;
        ...
        SIMULATION_DATA.AISM.control = (1.0/aism_b)*(-aism_f - aism_nu_e - aism_alfa*aism_s - aism_gamma*SIMULATION_DATA.AISM.int_aism_s);
                
        %------------- Update control states -------------% 
        SIMULATION_DATA.AISM.int_aism_s = SIMULATION_DATA.AISM.int_aism_s + aism_s*PARAMETERS.SAMPLING_TIME;
        SIMULATION_DATA.AISM.int_dot_aism_alfa = SIMULATION_DATA.AISM.int_dot_aism_alfa + dot_aism_alfa*PARAMETERS.SAMPLING_TIME;
...
%     title('Detailed view of yaw error at steady-state');
    ...
    legend('Reference','Concise Backstepping (Zhang et al.)','Synergetic (Muhammad et al.)','Adaptive Sliding Mode (González-Prieto et al.)', 'Interpreter','latex','FontSize', PARAMETERS.PLOT_FONT_SIZE); 
    ...
    subplot(3,1,1);
    plot(SIMULATION_DATA.data(:,1), SIMULATION_DATA.NICB.data(:,4) ,'-', 'Color', 'r', 'LineWidth',1.0);    
    if create
        grid on;
        hold on;
    ...
    plot(SIMULATION_DATA.data(:,1), SIMULATION_DATA.SYN.data(:,4) ,'-', 'Color', 'b', 'LineWidth',1.0);    
    plot(SIMULATION_DATA.data(:,1), SIMULATION_DATA.AISM.data(:,4),'-', 'Color', 'k', 'LineWidth',1.0);    
    legend('Concise Backstepping (Zhang et al.)','Synergetic (Muhammad et al.)','Adaptive Sliding Mode (González-Prieto et al.)', ...
        'Interpreter','latex','FontSize', PARAMETERS.PLOT_FONT_SIZE,'location','southeast'); 
   
    subplot(3,1,2);
    plot(SIMULATION_DATA.data(:,1), SIMULATION_DATA.NICB.data(:,5) ,'-', 'Color', 'r', 'LineWidth',1.0);    
    if create
        grid on;
        hold on;
    ...
    plot(SIMULATION_DATA.data(:,1), SIMULATION_DATA.SYN.data(:,5) ,'-', 'Color', 'b', 'LineWidth',1.0);    
    plot(SIMULATION_DATA.data(:,1), SIMULATION_DATA.AISM.data(:,5) ,'-', 'Color', 'k', 'LineWidth',1.0);    
    
    axes('Position',[.55 .50 .3 .1])
    box on
    data_size = size(SIMULATION_DATA.data(:,1),1) - 1;
    detail_size = floor(200.0/PARAMETERS.SAMPLING_TIME);  
    from_to_detail = data_size-detail_size:data_size;    
    plot(SIMULATION_DATA.data(from_to_detail,1), SIMULATION_DATA.NICB.data(from_to_detail,5),'-', 'Color', 'r', 'LineWidth',1.0);
    grid on;
    hold on;
    ...
    if PARAMETERS.CREATE_PDF
        if PARAMETERS.SIMULATION_TYPE == 1
            if PARAMETERS.DISTURBANCE_TYPE == 1
                figure(1);
                export_fig('../MANUSCRIPT/GRAPHICS/constant_reference_disturbance_states_control.pdf', '-transparent');
                figure(2);
                export_fig('../MANUSCRIPT/GRAPHICS/constant_reference_disturbance_performance.pdf', '-transparent');
                figure(4);
                export_fig('../MANUSCRIPT/GRAPHICS/constant_reference_disturbance_parameters.pdf', '-transparent');
                figure(5);
                export_fig('../MANUSCRIPT/GRAPHICS/constant_reference_disturbance_s_d.pdf', '-transparent');
            else                
                figure(1);
                export_fig('../MANUSCRIPT/GRAPHICS/constant_reference_states_control.pdf', '-transparent');
                figure(2);
                export_fig('../MANUSCRIPT/GRAPHICS/constant_reference_performance.pdf', '-transparent');
                figure(4);
                export_fig('../MANUSCRIPT/GRAPHICS/constant_reference_parameters.pdf', '-transparent');
                figure(5);
                export_fig('../MANUSCRIPT/GRAPHICS/constant_reference_s_d.pdf', '-transparent');
            end
        else
            if PARAMETERS.DISTURBANCE_TYPE == 1
                figure(1);
                export_fig('../MANUSCRIPT/GRAPHICS/sinusoidal_reference_disturbance_states_control.pdf', '-transparent');
                figure(2);
                export_fig('../MANUSCRIPT/GRAPHICS/sinusoidal_reference_disturbance_performance.pdf', '-transparent');
                figure(4);
                export_fig('../MANUSCRIPT/GRAPHICS/sinusoidal_reference_disturbance_parameters.pdf', '-transparent');
                figure(5);
                export_fig('../MANUSCRIPT/GRAPHICS/sinusoidal_reference_disturbance_s_d.pdf', '-transparent');
            else                
                figure(1);
                export_fig('../MANUSCRIPT/GRAPHICS/sinusoidal_reference_states_control.pdf', '-transparent');
                figure(2);
                export_fig('../MANUSCRIPT/GRAPHICS/sinusoidal_reference_performance.pdf', '-transparent');
                figure(4);
                export_fig('../MANUSCRIPT/GRAPHICS/sinusoidal_reference_parameters.pdf', '-transparent');
                figure(5);
